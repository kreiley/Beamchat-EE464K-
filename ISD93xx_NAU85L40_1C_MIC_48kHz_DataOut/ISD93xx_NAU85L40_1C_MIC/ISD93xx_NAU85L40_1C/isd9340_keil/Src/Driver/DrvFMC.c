...
/*               							                                                               */
/* Description:                                                                                            */
/*               To write data into Flash include APROM, LDROM, Data Flash, and Config	                   */
/*---------------------------------------------------------------------------------------------------------*/
...
/*               							                                                               */
/* Description:                                                                                            */
/*               To read data from Flash include APROM, LDROM, Data Flash, and Config	                   */
/*---------------------------------------------------------------------------------------------------------*/
...
/*                                                                                                         */
/* Parameters:                                                                                             */
/*               u32addr 	    - [in]		Source address       										   */
/*               u32data 	    - [in]		Read back data      				   						   */
/*               u32buffersize  - [in]      Total count     		                           	   		   */
/*               									      		                           				   */
/* Returns:                                                                                                */
/*               0		 Success																		   */
/*              <0       Failed when illegal condition occurs					                  		   */
/*               							                                                               */
/* Description:                                                                                            */
/*               Continue read back data from source address to a limit length	                       	   */
/*---------------------------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------------------------*/
/* Function: DrvFMC_WriteBuffer				                                               	  	   		   */
/*                                                                                                         */
/* Parameters:                                                                                             */
/*               u32addr 	    - [in]		Source address       										   */
/*               u32data 	    - [in]		write data           				   						   */
/*               u32buffersize  - [in]      Total count     		                           	   		   */
/*               									      		                           				   */
/* Returns:                                                                                                */
/*               0		 Success																		   */
...
/*               							                                                               */
/* Description:                                                                                            */
/*               Continue write data from source address to a limit length	                         	   */
/*---------------------------------------------------------------------------------------------------------*/
