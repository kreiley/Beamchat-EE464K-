...
#define PWMB_CNR0        PWMB_BA + 0x0C
#define PWMB_PDR0        PWMB_BA + 0x14
#define PWMB_CRLR0       PWMB_BA + 0x58
#define PWMB_CFLR0       PWMB_BA + 0x5C
...
/*                                                                                                         */
/* Parameters:                                                                                             */
/*               u8Timer   - [in]		DRVPWM_TIMER0 ~ DRVPWM_TIMER5 								       */
/*                                                                                                         */
/* Returns:                                                                                                */
/*               0		disable                                                                            */
/*               1		enable	                                                                           */
	...
	else
	{
		switch (u8Timer)
		{
			...
			case DRVPWM_TIMER1:
				...
				break;
			case DRVPWM_TIMER2:
				status = PWMA->PIFR.PWMIF2;
				break;
			case DRVPWM_TIMER3:
				status = PWMA->PIFR.PWMIF3;
				break;
			case DRVPWM_TIMER4:
				status = PWMB->PIFR.PWMIF0;
				break;
			case DRVPWM_TIMER5:
				status = PWMB->PIFR.PWMIF1;
				break;
		}
	}
...
/*                                                                                                         */
/* Parameters:                                                                                             */
/*               u8Capture 		- [in]		DRVPWM_CAP0 ~ DRVPWM_CAP5 								       */
/*              											                                        	   */
/* Returns:                                                                                                */
...
/*                                                                                                         */
/* Parameters:                                                                                             */
/*               u8Timer 						DRVPWM_TIMER0~DRVPWM_TIMER5							       */
/*         										DRVPWM_CAP0~DRVPWM_CAP5						        	   */
...
/*												u8Timer = DRVPWM_CAP0~DRVPWM_CAP5) 						   */
/*              											                                        	   */
/* Returns:                                                                                                */
...
uint32_t DrvPWM_SetTimerClk(uint8_t u8Timer, S_DRVPWM_TIME_DATA_T *sPt)
{
	...
	if (u8EngineClk == 0)		 /* external 10kHz internal osc	*/
	{
		u32Freqout = 10000;
	}
