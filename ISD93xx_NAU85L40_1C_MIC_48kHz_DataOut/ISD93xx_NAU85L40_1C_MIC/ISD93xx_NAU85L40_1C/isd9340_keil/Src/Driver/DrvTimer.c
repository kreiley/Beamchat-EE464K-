...
static WDT_CALLBACK fnCallBack_WDT = 0;

static int8_t  bIsTimer0Initial     = FALSE,
...
static uint32_t GetTimerCLk(TIMER_CHANNEL ch)
{
	...
	if(ch == TMR0 )
	{
		...
		{
		    clk = 16000;						/* Option 0: 10K  */ 
		}
		else if(SYSCLK->CLKSEL1.TMR0_S == 1)
		{
			clk = 32768;						/* Option 1: 32K */
		}
